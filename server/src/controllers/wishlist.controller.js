...
/**
 * @desc Toggle a product in the wishlist (adds if missing, removes if present)
 * @route POST /api/v1/wishlist/:productId/toggle
 * @access Private
 */
const toggleWishlist = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, populatedWishlist, message));
});

export { getWishlist, addToWishlist, removeFromWishlist, clearWishlist, toggleWishlist };
